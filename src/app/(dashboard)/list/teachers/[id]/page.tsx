        ...
        <div className='w-full xl:w-1/3 flex flex-col gap-4'>
            <div className='bg-white p-4 rounded-md'>
                ...
                <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
                    <Link className="p-3 rounded-md bg-yeoriSkyLight" href="/">Teacher&apos;s Class</Link>
                    <Link className="p-3 rounded-md bg-yeoriPurpleLight" href="/">Teacher&apos;s Students</Link>
                    <Link className="p-3 rounded-md bg-yeoriYellowLight" href="/">Teacher&apos;s Lessons</Link>
                    <Link className="p-3 rounded-md bg-pink-50" href="/">Teacher&apos;s Exams</Link>
                    <Link className="p-3 rounded-md bg-yeoriSkyLight" href="/">Teacher&apos;s Assignments</Link>
                </div>
            </div>
            <Performance/>
            <Announcements/>
